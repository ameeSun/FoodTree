...
struct PostComposerView: View {
    ...
    private func publishPost() {
        ...
        guard trimmedTitle.count >= 3 else { publishError = "Title must be at least 3 characters long"; return }
        guard trimmedTitle.count <= 200 else { publishError = "Title must be no more than 200 characters long"; return }
        ...
        Task { @MainActor in
            do {
                ...
                let imageDataArray = viewModel.photos.compactMap { $0.jpegData(compressionQuality: 0.8) }
